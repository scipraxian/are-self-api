...
from hydra.models import HydraSpellbook, HydraSpawn, HydraSpawnStatus, HydraHeadStatus
...
class HydraExclusivityTests(StaticLiveServerTestCase):
    ...
    def test_buttons_hidden_during_run(self):
        with sync_playwright() as p:
            ...
            expect(page.get_by_role("button",
                                    name="Fast Validate")).to_be_visible()
            ...
            from hydra.models import HydraSpell, HydraHead
            ...
            spawn = HydraSpawn.objects.create(
                spellbook=self.book1, status_id=HydraSpawnStatus.RUNNING)
            ...
            expect(page.get_by_role("button",
                                    name="Fast Validate")).not_to_be_visible()
            expect(page.get_by_role("button",
                                    name="Full Run")).not_to_be_visible()
            ...
            expect(page.get_by_text(
                "OPERATION: Fast Validate")).not_to_be_visible()
    ...
    def test_zombie_spawn_cleanup(self):
        with sync_playwright() as p:
            ...
            HydraSpawn.objects.create(spellbook=self.book1,
