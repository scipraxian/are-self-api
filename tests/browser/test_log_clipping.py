...
class LogClippingTests(StaticLiveServerTestCase):
    ...
    def test_log_buttons_visibility(self):
        ...
        with sync_playwright() as p:
            ...
            self.assertLessEqual(btn_box['x'] + btn_box['width'], 400, f"Download button is clipped by viewport (x={btn_box['x']}, w={btn_box['width']})")
            ...
            self.assertLessEqual(btn_box['x'] + btn_box['width'], container_box['x'] + container_box['width'] + 1, "Download button overflows container")
