...
from vocal_auditory_cortex.providers import stt_faster_whisper


class SttFasterWhisperTests(SimpleTestCase):
    """Tests for faster-whisper provider with mocked model."""

    @patch('vocal_auditory_cortex.providers.stt_faster_whisper.WhisperModel', None)
    ...
    @patch('vocal_auditory_cortex.providers.stt_faster_whisper.WhisperModel')
    def test_transcribe_returns_text_from_segments(self, mock_wm_class):
        ...
        model.transcribe.return_value = (
            [segment, seg2],
            MagicMock(language='en', duration=1.2),
        )
