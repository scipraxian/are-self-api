...
from talos_hippocampus.talos_hippocampus import (
...
class TestHippocampusVectors:
    ...
    @pytest.mark.asyncio
    @patch('talos_hippocampus.talos_hippocampus.ModelRegistry.objects.get')
    @patch('talos_hippocampus.talos_hippocampus.sync_to_async')
