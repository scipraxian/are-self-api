...
The **occipital_lobe** module is "log vision": it reads SpikeTrain/Spike logs, extracts error blocks with context, filters noise patterns, and truncates output to fit a token budget for LLM context injection.
